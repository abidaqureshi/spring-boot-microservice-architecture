package com.rakutan.usersservice.config;

import com.rakutan.usersservice.config.intercepter.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    //declare bean of OAuth2AuthorizedCliet manager
